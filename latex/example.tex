...
\newcommand{\bgoesswe}[1]{{\color{blue}#1}}
...
We define the term "reproducibility" by running a second different \gls{experiment}, which arrives at the same conclusion as the original experiment. The more an additional experiment differs from an original one, the more information is gained. It is necessary to produce evidence for the outcome of an experiment. We define the term "replicability" as the re-run of the same methods of an original experiment to show that the described methods lead to the claimed results \cite{reprovsrepli}. \\

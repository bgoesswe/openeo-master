...
\todo{maybe better example with real usecase, or is this a real use case ? maybe explain what can be retrieved by this}
...
\todo{find meaning for maximum instead of minimum, so what would be the interest..}
\begin{itemize}

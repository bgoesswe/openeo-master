...
# Get state of the resultfiles, so if they changed since the original execution 
file_listA["input_files"]["state"] # Returns "EQUAL"
	...
	\end{listing}
	After executing the job the pidA is created as "qu-78aab90a-13e6-4722-9237-924713de6b43". The resulting file list consists of 51 files and the re-execution of the query results in the same 51 files. 
...
\todo{Show concrete example see Feedback for detailed storyline}

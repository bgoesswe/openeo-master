...
\item \textbf{Data Identifier Landing Page} \\
	...
	\bgoesswein{The landing page contains the citation text for the data. In EODC only Sentinel data is available for the users. EODC already stores the official citation text from ESA. In addition to this text we add the data PID and filter arguments.}
...
\begin{code}
	...
	Copernicus Sentinel data (2017). Retrieved from EODC, Austria [2019-04-17], processed by ESA. PID: BACKEND_URL/data/qu-d1701f4e-e7c5-4a83-92e0-9facbd401a06
	\end{minted}
...
\begin{itemize}
	...
	\item \textbf{R10: Automated Citation Texts} \\
	The citation text for the dataset is already available at EODC. We added the generated data PID and filter arguments. \todo{Link to automated citation text}

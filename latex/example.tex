...
\setfirstassistant{Projektass. Dr.techn. Mag.}{Tomasz Miksa}{}{male}
...
\setdate{23}{08}{2019} % Set date with 3 arguments: {day}{month}{year}.
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.45]{implementation_dataoverview}
	...
	\label{fig:implementation_dataoverview} % \label has to be placed AFTER \caption (or \subcaption) to produce correct cross-references.
\end{figure}
...
%/eodc/products/copernicus.eu/s2a_prd_msil1c/2017/05/04/
...
\begin{itemize}
	...
	\item \textbf{R10: Automated Citation Texts} \\
	The citation text for the dataset is already available at EODC. We added the generated data PID and filter arguments {(See Listing \ref{lst:use_case1_citation})}. %\todo{Link to automated citation text}

...
\begin{abstract}
\todo{See paper, but adapt it, since this thesis is more complex}
\todo{1. Context, 2. Problem, 3. Mentioning Related work a bit, 4. My Contribution}
\todo{Zuerst Sachen definieren bevor sie verwendet werden.}
\todo{"great concept of reproducibility" --> zu grob, grobe Begriffe vermeiden}
...
\todo{EODC + openEO should be in the solution not in the context}
...
\todo{Paper mit falsche Reproducibility definition streichen bzw. nicht als "Definition" verwenden, die Definition hier passt aber, nur zum Checken}

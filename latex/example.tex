...
\todo{Add figure of example request -> response (see comparison JSON).}
...
\begin{enumerate}
	...
	\end{lstlisting}  
	\todo{Finish it !! Add pictures of comparison to implementation section, and maybe also visualization if you are motivated...}
\end{enumerate}
...
\section{Conclusion}
\todo{no separation of used packages and not used packages}
5.	Summary of thesis

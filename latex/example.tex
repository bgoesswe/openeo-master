...
\begin{itemize}
	...
	\begin{itemize}
		...
		The original software is defined by the used code, the programming language, and the installed libraries. A version control system is needed to identify the code. In the implementation, Git and GitHub are used to identify and persist the used code version. The version of the programming language and the installed packages are stored in the job dependent context model. The backend has to recreate the captured versions of code and state of the programming language to reproduce the first execution.       
